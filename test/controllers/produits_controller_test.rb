...
class ProduitsControllerTest < ActionController::TestCase
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post :create, produit: { description: @produit.description, nom: @produit.nom, string: @produit.string, string: @produit.string }
    end
  ...
  test "should update produit" do
    patch :update, id: @produit, produit: { description: @produit.description, nom: @produit.nom, string: @produit.string, string: @produit.string }
    assert_redirected_to produit_path(assigns(:produit))
  end
